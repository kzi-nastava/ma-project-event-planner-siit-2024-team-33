 ...
 * Use the {@link OfferingsPage#newInstance} factory method to
...
public class OfferingsPage extends Fragment {
     ...
     * @return A new instance of fragment OfferingsPage.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button b1 = view.findViewById(R.id.offerings_create_button);
        b1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getActivity(), activity_service_create.class);
                startActivity(i);
            }
        });
